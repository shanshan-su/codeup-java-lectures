...
public class ArraysLecture {
    ...
    public static void main(String[] args) {
        ...
        String[] members = {"J", "Shan", "E", "J"};
        System.out.println("members[0] = " + members[0]);
        ...
        for (String cohort : cohorts) { // for(dataType singular : arrName) {do some stuff}
            System.out.println("Codeup runs a few cohorts at a time - one of them from 2021 is " + cohort);
        }
        System.out.println();
        ...
        for (String member : members) {
            ...
            System.out.printf("There are %d members in my family and one of them is %s.\n", number, member);
        }
        System.out.println();
        ...
        Arrays.fill(groceryList, 1, 5, "ice cream");
        ...
        String cohortNameString2 = Arrays.toString(cohorts).replace("[", "").replace("]", "");

        System.out.println(cohortNameString2 + " cohorts are reporting for duty!");
        System.out.println();
