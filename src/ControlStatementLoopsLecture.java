...
public class ControlStatementLoopsLecture {
    public static void main(String[] args) {
        // Boolean Expressions
        // An expression that evaluates to a boolean value (5 == 5 //true, 5 < 6 //false)
        // These rational operators will have similarities to our JavaScript work - however: no truth-y, or false-y (no === vs ==, <== vs <=, etc.)
...
//        }
        ...
        System.out.println("str1.equals(str2) = " + str1.equals(str2)); // there ya go - use this method!

        String cohortLC = "marco";
        String cohortUC = "Marco";

        System.out.println("cohortLC.equalsIgnoreCase(cohortUC) = " + cohortLC.equalsIgnoreCase(cohortUC)); //Excellent - use this method!


        // ~ - ~ * Control Structures * ~ - ~
        // Rely on our foundation in JS here - much of the logic will be similar in pur head as to what is going on
...
//            System.out.println("Show me the 'admin' button on the home page and all recent posts by all users");
//        } else if (isLoggedIn && isOwner) {
//            System.out.println("Show the 'my account' button with this user's most recent  posts");
//        } else if (isLoggedIn) {
//            System.out.println("Show a 'create post' button ad well as examples of posts by other users.");
//        } else if (!isLoggedIn) {
...
//        }
//
//        String [] fruits = {"apple", "bananas", "jackfruit"};
//
...
//        }
        ...
        // Goal: Print only up tp the number 7
