...
//        example2.cohort = "Marco";
        ...
        // nathan.name = "Nathan Adcock", we didn't do this!

        System.out.println("nathan.name = " + nathan.name);
        System.out.println("nathan.cohort = " + nathan.cohort);

        // I'm still in a pickle: I need a method to handle if the student name is on record ans we have an assigned cohort on record! Well, let's just make another method for that!
