...
public class StringsLecture {
    public static void main(String[] args) {
        ...
        // .startsWith and .endWith [with a bonus: .contains!]
        ...
        System.out.println("austinSentence.startsWith(\"the city\") = " + austinSentence.startsWith("the city"));
        System.out.println();

        System.out.println("austinSentence.contains(\"it is growing quickly\") = " + austinSentence.contains("it is growing quickly"));
        ...
        // String .replace(searchPattern, replacementString) - returns  a copy of the string with the matching pattern replaced by the second argument & it'll replace each matching pattern
        System.out.println("austinSentence = " + austinSentence);
//        The capital city of Texas is Austin, and it is growing quickly.
        ...
        String theIsTestSentence = austinSentence.replace("is", "is not");
        System.out.println("theIsTestSentence = " + theIsTestSentence);

        // .toLowerCase() vs .toUpperCase() - don't change the original string
        System.out.println("txCapitalCity = " + txCapitalCity);
        ...
        // .trim() - trim the whitespace out of a string
        String userInputString = "       austin         ";
        System.out.println("userInputString = " + "The capital city of  Texas is " + userInputString + ".");
        System.out.println("userInputString.trim() = " + "The capital city of Texas is " + userInputString.trim() + ".");
